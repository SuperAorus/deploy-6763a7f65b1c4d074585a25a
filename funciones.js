...
const audios = [
  { ruta: "audios/1_es.mp3", id: "segura" },
  { ruta: "audios/2_es.mp3", id: "plomo" },
  { ruta: "audios/3_es.mp3", id: "sabor" },
  { ruta: "audios/4_es.mp3", id: "salud" },
  { ruta: "audios/5_es.mp3", id: "piel" },
  { ruta: "audios/6_es.mp3", id: "dinero" }
];
...
function esElementoVisible(elemento, porcentajeVisible) {
  ...
  enlace.classList.remove('active');
		...
		const logo1 = document.querySelector('.logo__img');
...
// Seleccionamos el logo de la barra
const logo1 = document.querySelector('.logo_img');

// Agregamos un evento click al logo
logo1.addEventListener('click', () => {
  // Scrollamos al top de la página de manera suave
  window.scrollTo({
    top: 0,
    behavior: 'smooth'
  });
